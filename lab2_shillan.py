...
print(f"The average mark {mark_average}")
...
print("\nExercise 5")
day_today = int(input("Enter today's day number (0=Monday, 6=Sunday): "))
days_trip = int(input("Enter the number of days of your trip: "))

day_after_trip = (day_today + days_trip) % 7

print(f"Your trip starts on day {day_today}, lasts {days_trip} days. You're back on day {day_after_trip}.")
